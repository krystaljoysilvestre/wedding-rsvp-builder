...
export default function SectionManager({
  ...
  return (
    <div className="space-y-5">
      ...
      {/* Available to add — grouped by tier */}
      {inactive.length > 0 && (
        <div className="space-y-5">
...
function SortableRow({
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`flex items-center gap-2 rounded-lg border bg-white px-3 py-2.5 transition-shadow ${
        isDragging
    ...
    >
      ...
      <button
        ...
        className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md text-[#A09580] transition-colors hover:bg-[#FAF7F2] hover:text-[#C53030]"
      >
        <svg
